...
def setup_logging():
    ...
    logging.basicConfig(
        ...
        handlers=[
            ...
            logging.FileHandler('test_charts.log', mode='w', encoding='utf-8')
        ]
    )
    ...
    test_data = {
        "detailed_results": [
            ...
            },
            {
                ...
                "nominal": 5.0,
                "tolerance": [-0.3, 0.3],
                "original_values": [5.05, 5.12, 5.08, 4.98, 5.15, 5.03, 4.95, 5.18, 5.06, 5.01,
                                  5.09, 5.14, 4.97, 5.11, 5.04, 5.16, 4.99, 5.07, 5.13, 5.02],
                "statistics": {
                    "mean": 5.063,
                    "sample_size": 20,
                    "std_short": 0.067,
            ...
            {
                "element_name": "Element_C",
                "nominal": 2.5,
                "tolerance": [-0.2, 0.2],
                "original_values": [2.52, 2.48, 2.51, 2.49, 2.53, 2.47, 2.50, 2.54, 2.46, 2.52,
                                  2.49, 2.51, 2.48, 2.53, 2.50, 2.47, 2.52, 2.49, 2.51, 2.48],
                "statistics": {
                    "mean": 2.498,
                    "sample_size": 20,
                    "std_short": 0.025,
...
def test_chart_manager():
    ...
    try:
        ...
        results = manager.create_all_charts(
            chart_types=['normality'],  # Only normality for now
