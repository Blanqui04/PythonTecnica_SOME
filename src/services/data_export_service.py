...
class DataExportService:
    ...
    def export_analysis_data(self, analysis_type: str, ref_project: str, client: str = None) -> dict:
        """
        ...
        try:
            ...
            if analysis_type == "dimensional":
                data = self._generate_dimensional_data(ref_project, client)
            elif analysis_type == "capacity":
                data = self._generate_capacity_data(ref_project, client)
            else:
                return {
                    'success': False,
            ...
            logger.info(f"Successfully exported {analysis_type} data for project {ref_project}")
    ...
    def export_csv_data(self, analysis_type: str, ref_project: str, client: str = None) -> dict:
        """
        ...
        try:
            ...
            logger.info(f"Successfully exported {analysis_type} CSV data for project {ref_project}")
            
            return {
                'success': True,
                'files': files_created,
                'filepath': str(self.downloads_dir),
                'downloads_folder': str(self.downloads_dir),
                'records_count': total_records
            }
    ...
    def _generate_dimensional_data(self, ref_project: str, client: str = None) -> dict:
    ...
    def _generate_capacity_data(self, ref_project: str, client: str = None) -> dict:
