...
if errorlevel 1 (
    ...
    if exist "requirements_compatible.txt" (
        ...
        echo    - Anar a: https://visualstudio.microsoft.com/visual-cpp-build-tools/
        echo    - Descarregar "Build Tools for Visual Studio"
        echo    - Executar com a administrador
        echo    - Seleccionar "C++ build tools"
        echo    - Marcar: MSVC v143 + Windows SDK
        echo    - Instal·lar i reiniciar PC
        echo.
